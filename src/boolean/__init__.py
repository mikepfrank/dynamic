# boolean/__init__.py - Initialization for the boolean package.
...
# package's directory, which in this case the the "boolean/" subdirectory
...
_logger = getLogger(sysName + '.' + __path__[0].split('\\')[-1])
    #   \_ This uses the package name ('boolean') as the component name.
